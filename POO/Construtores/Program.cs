...
Aluno2 ggoncalves = new Aluno2("Guilherme Gonçalves");
ggoncalves.CPF = 010508;

Aluno2 vini7 = new Aluno2("Vinicius Polimeno");
vini7.CPF = 030108;


Console.WriteLine(ggoncalves.Nome);
Console.WriteLine(ggoncalves.CPF);

Console.WriteLine(vini7.Nome);
Console.WriteLine(vini7.CPF);
